...
:: COPY STANDARD FILES
if exist "%VENUS_DIRECTORY%\Tools\%1\Ve*.h"																			xcopy /D /F /I /R /Y "%VENUS_DIRECTORY%\Tools\%1\Ve*.h"																		"%SDK_DIRECTORY%\Include"
if exist "%VENUS_DIRECTORY%\Tools\%1\Ve*.inl"																		xcopy /D /F /I /R /Y "%VENUS_DIRECTORY%\Tools\%1\Ve*.inl"																	"%SDK_DIRECTORY%\Include"
